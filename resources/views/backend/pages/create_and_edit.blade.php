            ...
            <div class="panel">
                <div class="panel-body">
                    <form id="form-validator" class="form-horizontal" method="POST"
                          action="{{ $page->id ? route('pages.update', $page->id) : route('pages.store') }}?redirect={{ previous_url() }}">
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" class="mini-hidden"
                               value="{{ $page->id ? 'PATCH' : 'POST' }}">
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            ...
                            <div class="col-md-5 col-sm-10">
                                <input type="text" name="subtitle" autocomplete="off" class="form-control"
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            ...
                            <div class="col-md-5 col-sm-10">
                                <input type="text" name="keywords" autocomplete="off" class="form-control"
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            ...
                            <div class="col-md-5 col-sm-10">
                                <textarea name="description" class="form-control"
                                          rows="4">{{  old('description', $page->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            ...
                            <div class="col-md-8 col-sm-10">
                                <script id="container" name="content" type="text/plain">{!! old('content', $page->content) !!}</script>
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                            ...
                            <div class="col-md-8 col-sm-10">
                                <div class="panel">
                                    <div class="panel-body">
                                        <img src="{{ storage_image_url($page->thumb) }}" id="image_image"
                                             class="img-rounded" width="660px" height="300px" alt="">
                                        <input type="hidden" name="image" id="form_thumb"
                                               value="{{ old('thumb',$page->thumb) }}"/>
                                        <button id="upload_thumb" type="button"
                                                class="btn btn-info uploader-btn-browse"><i
                                                class="icon icon-upload"></i> 上传
                                        </button>
                                        <button id="select_thumb" type="button" class="btn btn-primary"><i
                                                class="icon icon-file-image"></i> 选择
                                        </button>
                        ...
                        <div class="form-group has-feedback has-icon-right">
                            ...
                            <div class="col-md-5 col-sm-10">
                                <input type="text" name="author" autocomplete="off" class="form-control"
                            ...
                            <div class="col-md-5 col-sm-10">
                                <div class="radio">
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="0" @if($page->status == 0) checked=""
                                               @endif required> 隐藏
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="1" @if($page->status == 1) checked=""
                                               @endif required> 显示
                                    </label>
                                </div>
                            </div>
