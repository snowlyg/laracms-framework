...
if(!function_exists("model_plural_name")){
    ...
    {
        // 从实体中获取完整类名，例如：snowlyg\Laracms\Models\User
        $full_class_name = get_class($model);

        // 获取基础类名，例如：传参 `snowlyg\Laracms\Models\User` 会得到 `User`
...
if( !function_exists("frontend_navigation") ){
    ...
    function frontend_navigation($category = 'desktop'){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->frontend($category);
    }
}
...
if( !function_exists("frontend_complete_navigation") ){
    ...
    function frontend_complete_navigation($category = 'desktop'){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->completeFrontend($category);
    }
}
...
if( !function_exists("frontend_current_brother_and_child_navigation") ){
    ...
    function frontend_current_brother_and_child_navigation($category = 'desktop', $showOneLevel = false){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->getCurrentBrothersAndChildNavigation($category, $showOneLevel);
    }
}
...
if( !function_exists("frontend_current_child_navigations") ){
    ...
    function frontend_current_child_navigations($category = 'desktop'){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->getCurrentChildNavigations($category);
    }
}
if( !function_exists("frontend_current_child_navigation") ){
    ...
    function frontend_current_child_navigation($category = 'desktop'){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->getCurrentChildNavigation($category);
    }
}
...
if( !function_exists("frontend_current_navigation") ){
    ...
    function frontend_current_navigation($category = 'desktop'){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->getCurrentNavigation($category);
    }
}
...
if( !function_exists("breadcrumb") ){
     ...
     */
    function breadcrumb(){
        return $navigationHandler = app(\snowlyg\Laracms\Handlers\NavigationHandler::class)->breadcrumb();
    }
}
...
if(!function_exists("get_block")){
    ...
    function get_block($object_id){
        ...
        $block =  app(\snowlyg\Laracms\Handlers\BlockHandler::class)->getBlockData($object_id);
...
if( !function_exists("laracms_log") ){
    ...
    function laracms_log($group, $type, $description, $model = null){
        return \snowlyg\Laracms\Models\Log::create([
            'group'          => $group,
            'type'           => $type,
